...
const std::array<ModeConfig, ALL_MODES_EFFECT_COUNT> mainModes = {{
    {DRAW, 3, 1},             // (0)  - [3.0]   - "Полная заливка"
    {DRAW, 1, 1},             // (1)  - [3.1]   - "Заливка змейкой 1"
    {DRAW, 2, 1},             // (2)  - [3.2]   - "Заливка змейкой 2"
    {DRAW, 4, 1},             // (3)  - [3.3]   - "Заливка змейкой 3"
    {DRAW, 5, 1},             // (4)  - [3.4]   - "Цветное дыхание"
    {COLORFUL_SPOTS, 255, 1}, // (5)  - [1.0]     - "Цветные пятна"
    {RAINBOWS, 1, 1},         // (6)  - [2.0]   - "Радуга колесо"
    {RAINBOWS, 2, 1},         // (7)  - [2.1]   - "Радуга волной 1"
    {RAINBOWS, 3, 1},         // (8)  - [2.2]   - "Радуга волной 2"
    {RAINBOWS, 4, 1},         // (9)  - [2.3]   - "Радуга змейкой"
    {RUNNING_LIGHTS, 1, 1},   // (10) - [4.0]   - "Бегущий огонек медленно"
    {RUNNING_LIGHTS, 2, 1},   // (11) - [4.1]   - "Бегущий огонек быстро"
    {RUNNING_LIGHTS, 3, 1},   // (12) - [4.2]   - "Бегущий огонек цветной"
    {RUNNING_LIGHTS, 4, 1},   // (13) - [4.3]   - "Бегущие огоньки 1"
    {RUNNING_LIGHTS, 5, 1},   // (14) - [4.4]   - "Бегущие огоньки 2"
    {RUNNING_LIGHTS, 7, 1},   // (15) - [4.5]   - "Бегущие огоньки 3"
    {RUNNING_LIGHTS, 6, 1},   // (16) - [4.6]   - "Цветная змейка"
    {JUMPING_LIGHTS, 1, 1},   // (17) - [12.0]  - "Прыгающие огоньки 1"
    {JUMPING_LIGHTS, 2, 1},   // (18) - [12.1]  - "Прыгающие огоньки 2"
    {JUMPING_LIGHTS, 3, 1},   // (19) - [12.2]  - "Прыгающие огоньки 3"
    {JUMPING_LIGHTS, 4, 1},   // (20) - [12.3]  - "Прыгающие огоньки 4"
    {JUMPING_LIGHTS, 5, 1},   // (21) - [12.4]  - "Прыгающий квадрат"
    {JUMPING_LIGHTS, 6, 1},   // (22) - [12.5]  - "Прыгающие точки"
    {SPACE, 2, 1},            // (23) - [5.0]   - "Космические корабли"
    {SPACE, 1, 1},            // (24) - [5.1]   - "Звездное небо"
    {SPACE, 3, 1},            // (25) - [5.2]   - "Пульсирующая звезда"
    {SPACE, 4, 1},            // (26) - [5.3]   - "Метеорный поток"
    {SPACE, 5, 1},            // (27) - [5.4]   - "Спиральная туманность"
    {FLASH_LIGHTS, 1, 1},     // (28) - [6.0]   - "Мерцающие огни 1"
    {FLASH_LIGHTS, 2, 1},     // (29) - [6.1]   - "Мерцающие огни 2"
    {FLASH_LIGHTS, 3, 1},     // (30) - [6.2]   - "Мерцающие огни 3"
    {WATER, 1, 1},            // (31) - [7.0]   - "Лагуна"
    {WATER, 2, 1},            // (32) - [7.1]   - "Бассейн"
    {WEATHER, 1, 1},          // (33) - [8.0]   - "Снегопад"
    {WEATHER, 2, 1},          // (34) - [8.1]   - "Метель"
    {WEATHER, 3, 1},          // (35) - [8.2]   - "Дождь"
    {WEATHER, 4, 1},          // (36) - [8.3]   - "Ливень"
    {COLORFUL_WAVES, 1, 1},   // (37) - [9.0]   - "Цветные волны 1"
    {COLORFUL_WAVES, 2, 1},   // (38) - [9.1]   - "Цветные волны 2"
    {COLORFUL_WAVES, 3, 1},   // (39) - [9.2]   - "Цветные волны 3"
    {COLORFUL_WAVES, 4, 1},   // (40) - [9.3]   - "Цветные волны 4"
    {COLORFUL_WAVES, 5, 1},   // (41) - [9.4]   - "Цветные волны 5"
    {ANIMATIONS, 1, 1},       // (42) - [10.0]  - "Анимации: Сердце"
    {ANIMATIONS, 2, 1},       // (43) - [10.1]  - "Смайлик"
    {ANIMATIONS, 3, 1},       // (44) - [10.2]  - "Прыгающий человечек"
    {ANIMATIONS, 4, 1},       // (45) - [10.3]  - "Файербол"
    {ANIMATIONS, 5, 1},       // (46) - [10.4]  - "Взрыв"
    {ANIMATIONS, 6, 1},       // (47) - [10.5]  - "'С НОВЫМ ГОДОМ' на японском"
    {ANIMATIONS, 7, 1},       // (48) - [10.6]  - "Приветствие на корейском"
    {ANIMATIONS, 8, 1},       // (49) - [10.7]  - "Цифровой сигнал"
    {ANIMATIONS, 9, 1},       // (50) - [10.8]  - "Синусоида"
    {ANIMATIONS, 10, 1},      // (51) - [10.9]  - "Цветные синусоиды"
    {ANIMATIONS, 11, 1},      // (52) - [10.10] - "Цветные линии 1"
    {ANIMATIONS, 12, 1},      // (53) - [10.11] - "Цветные линии 2"
    {ANIMATIONS, 13, 1},      // (54) - [10.12] - "Цветные линии 3"
    {ANIMATIONS, 14, 1},      // (55) - [10.13] - "Цветные линии 4"
    {GAMES, 1, 1},            // (56) - [11.0]  - "Игра змейка"
    {GAMES, 2, 1},            // (57) - [11.1]  - "Игра тетрис"
    {GAMES, 3, 1},            // (58) - [11.2]  - "Игра арканоид"
    {MATRIX_MOVIE, 1, 1}      // (59) - [13.0]  - "Эффект из к/ф матрица"
}};
...
void handleDrawImage() { drawImages((uint8_t)((server.arg("img")).toInt())); }
