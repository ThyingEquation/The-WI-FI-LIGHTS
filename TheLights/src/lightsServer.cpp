...
static void handleMainCommand()
{
  ...
  {
    deviceEffectsState.effectsGroup = DRAW;
  ...
  {
    deviceEffectsState.effectsGroup = SPACE;
  ...
  {
    deviceEffectsState.effectsGroup = GAMES;
  ...
  {
    deviceEffectsState.effectsGroup = MATRIX_MOVIE;
